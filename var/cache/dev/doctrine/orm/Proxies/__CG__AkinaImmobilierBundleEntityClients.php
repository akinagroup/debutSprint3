 ...
 */
class Clients extends \Akina\ImmobilierBundle\Entity\Clients implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Akina\\ImmobilierBundle\\Entity\\Clients' . "\0" . 'id', '' . "\0" . 'Akina\\ImmobilierBundle\\Entity\\Clients' . "\0" . 'numeroPiece', '' . "\0" . 'Akina\\ImmobilierBundle\\Entity\\Clients' . "\0" . 'prenom', '' . "\0" . 'Akina\\ImmobilierBundle\\Entity\\Clients' . "\0" . 'nom', '' . "\0" . 'Akina\\ImmobilierBundle\\Entity\\Clients' . "\0" . 'telephone', '' . "\0" . 'Akina\\ImmobilierBundle\\Entity\\Clients' . "\0" . 'addresse', '' . "\0" . 'Akina\\ImmobilierBundle\\Entity\\Clients' . "\0" . 'email'];
        }
